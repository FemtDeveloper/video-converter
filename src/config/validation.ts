...
export const validationSchema = Joi.object({
  ...
  VOSK_MODEL_PATH_EN: Joi.string().allow(''),
  VOSK_MODEL_PATH_ES: Joi.string().allow(''),
  VOSK_MODEL_PATH_PT: Joi.string().allow(''),
  VOSK_MODEL_PATH_DE: Joi.string().allow(''),
  VOSK_MODEL_PATH_HI: Joi.string().allow(''),
  VOSK_MODEL_PATH_ZH: Joi.string().allow(''),
